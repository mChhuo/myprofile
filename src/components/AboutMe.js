    ...
    <div id="about-me-section" className="section">
      ...
      <div id="details">
        <div id="profile">
          ...
          demonstrate a strong work ethic. Having been a tutor and currently a
          volleyball coach, I have developed great communication and
        ...
        <div>
          ...
          <br />
          <h3>Email:</h3>
          <div>michaelchhuo10@hotmail.com</div>
        </div>
      </div>
    </div>
  );
